...
return [
    ...
    // ORDER
    'order_model' => 'App\Models\Override\Order',
    ...
    // PRODUCT -> resources
    'product_tiny_resource' => 'App\Http\Resources\ProductTinyResource',
    
    // Small product resource used for catalog pages (index route)
    'product_small_resource' => 'App\Http\Resources\ProductSmallResource',
    ...
    'product_large_resource' => 'App\Http\Resources\ProductLargeResource',
